const API_KEY = '2a054394ff7333f4c68b3cc82e5d820c';
        ...
        return[
            {
                ...
                items: await basicFetch(`/discover/tv?with_networks=213&language=pt_BR&api_key=${API_KEY}`)
            },
            {
                slug: 'trending',
                title: 'Recomendados para Você',
                items: await basicFetch(`/trending/all/week?languege=pt_BR&api_key=${API_KEY}`)
            },
            {
                slug: 'toprated',
                title: 'Em alta',
